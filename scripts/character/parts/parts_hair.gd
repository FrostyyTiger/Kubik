...
const LIZARD_CREST_LOW := {
	"size": Vector3i(4, 8, 14),
	"anchor": Vector3(2, -18, 6),
	"slices": [
...
# The same fin, half again as tall and reaching past the back of the skull.

const LIZARD_CREST_TALL := {
	"size": Vector3i(4, 12, 16),
	"anchor": Vector3(2, -18, 6),
	"slices": [
		["HHHH", "HHHH", "HHHH", "HHHH", "HHHH", "HHHH", "HHHH", "HHHH", "HHHH",
		 "HHHH", "HHHH", "HHHH", "HHHH", "HHHH", "HHHH", "HHHH"],
