...
## socket.
##
## GENERATED by tools/parts_author/gear.py. Re-run
...
const SWORD := {
	"size": Vector3i(9, 42, 3),
	"anchor": Vector3(-7.5, 0, 1.5),
	"slices": [
		["...DDD...", "...DDD...", "...DDD..."],
		["...DDD...", "...DDD...", "...DDD..."],
		["...DDD...", "...DDD...", "...DDD..."],
...
const TUNIC := {
	"size": Vector3i(12, 18, 2),
	"anchor": Vector3(6, 9, 2),
	"slices": [
...
const PENDANT := {
	"size": Vector3i(9, 18, 3),
	"anchor": Vector3(4.5, 18, 21),
	"slices": [
