...
*2026-09-04: the reconciliation's order (`RECONCILIATION.md` § 9, `CLAUDE.md` § Working order) is the queue now, reordered by Marcel for the north star (D84). Everything below A9 is the queue behind it.*
...
- [ ] **A8. Mesher v1 - the chunk mesher in C++** (1-2 nights, `docs/plans/mesher-v1.md`, phase 1b, D56) - **LAUNCHED 2026-09-04** on `feat/mesher-v1`, ganymede tmux `mesher-v1`. `||` with A7; zero-overlap file lists in both plans.
